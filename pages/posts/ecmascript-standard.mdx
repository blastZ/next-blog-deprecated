...
export const frontMatter = {
  ...
  title: 'ECMAScript 标准',
  subTitle: '介绍 ECMAScript 标准，以及在 TC39 发布流程下，各个阶段的意义。',
  tags: ['javascript'],
  date: '2019/05/15',
  thumb: '/static/thumbs/ecmascript-standard.webp',
  published: true
};
...
新名字里的 ECMA 来源于发起这个标准的组织，最早叫 欧洲电脑制造商协会（European Computer Manufacturers Association），后来为了国际化改名叫 Ecma International 。
...
<img src="/static/posts/ecmascript-standard/tc39_process.webp" />
